...
// Calendar locale - dynamically set based on I18N_LANG
(function() {
    var calLang = (typeof I18N_LANG !== 'undefined') ? I18N_LANG : 'zh-cn';
    var calLocales = {
        'zh-cn': {
            _DN: ["星期日","星期一","星期二","星期三","星期四","星期五","星期六","星期日"],
            _SDN: ["日","一","二","三","四","五","六","日"],
            _MN: ["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],
            _SMN: ["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],
            _FD: 0,
            _TT: {
                "INFO": "帮助",
                "ABOUT": "关于 DHTML 日期/时间选择器\n",
                "ABOUT_TIME": "\n\n时间选择：\n- 点击时间部件增减当前值\n- Shift+点击减小值\n- 拖动鼠标快速改变值",
                "PREV_YEAR": "上一年 (按住出菜单)",
                "PREV_MONTH": "上一月 (按住出菜单)",
                "GO_TODAY": "转到今日",
                "NESMS_MONTH": "下一月 (按住出菜单)",
                "NESMS_YEAR": "下一年 (按住出菜单)",
                "SEL_DATE": "选择日期",
                "DRAG_TO_MOVE": "拖动",
                "PART_TODAY": " (今日)",
                "DAY_FIRST": "最左边显示%s",
        ...
        'my-mm': {
            _DN: ["တနင်္ဂနွေ","တနင်္လာ","အင်္ဂါ","ဗုဒ္ဓဟူး","ကြာသပတေး","သောကြာ","စနေ","တနင်္ဂနွေ"],
            _SDN: ["နွေ","လာ","ဂါ","ဟူး","တေး","ကြာ","နေ","နွေ"],
            _MN: ["ဇန်နဝါရီ","ဖေဖော်ဝါရီ","မတ်","ဧပြီ","မေ","ဇွန်","ဇူလိုင်","ဩဂုတ်","စက်တင်ဘာ","အောက်တိုဘာ","နိုဝင်ဘာ","ဒီဇင်ဘာ"],
            _SMN: ["ဇန်","ဖေ","မတ်","ဧ","မေ","ဇွန်","ဇူ","ဩ","စက်","အောက်","နို","ဒီ"],
            _FD: 0,
            _TT: {
                "INFO": "အကူအညီ",
                "ABOUT": "DHTML ရက်/အချိန်ရွေးချယ်ရေး\n",
                "ABOUT_TIME": "\n\nအချိန်ရွေးချယ်ရန် - နှိပ်ပါ - Shift+နှိပ်ပါ - ဆွဲချပါ",
                "PREV_YEAR": "ယခင်နှစ်",
                "PREV_MONTH": "ယခင်လ",
                "GO_TODAY": "ယနေ့သို့",
                "NESMS_MONTH": "နောက်လ",
                "NESMS_YEAR": "နောက်နှစ်",
                "SEL_DATE": "ရက်စွဲရွေးချယ်ပါ",
                "DRAG_TO_MOVE": "ရွှေ့ရန်ဆွဲပါ",
                "PART_TODAY": " (ယနေ့)",
                "DAY_FIRST": "ဘယ်ဘက်တွင်%sပြသရန်",
                "WEEKEND": "0,6",
                "CLOSE": "ပိတ်ပါ",
                "TODAY": "ယနေ့",
                "TIME_PART": "တန်ဖိုးပြောင်းလဲရန် (Shift-)နှိပ်ပါ သို့ ဆွဲပါ",
                "DEF_DATE_FORMAT": "%Y-%m-%d",
        ...
        'en-us': {
            ...
            _TT: {
                "INFO": "Help",
                "ABOUT": "About DHTML Date/Time Selector\n",
                "ABOUT_TIME": "\n\nTime selection: - Click to increase - Shift+Click to decrease - Drag to change fast",
                "PREV_YEAR": "Prev. year (hold for menu)",
                "PREV_MONTH": "Prev. month (hold for menu)",
                "GO_TODAY": "Go Today",
                "NESMS_MONTH": "Next month (hold for menu)",
                "NESMS_YEAR": "Next year (hold for menu)",
    ...
    var loc = calLocales[calLang] || calLocales['zh-cn'];
    Calendar._DN = loc._DN;
    Calendar._SDN = loc._SDN;
    Calendar._MN = loc._MN;
    Calendar._SMN = loc._SMN;
    Calendar._FD = loc._FD;
    Calendar._TT = loc._TT;
})();

// Locale strings are now set dynamically above via I18N_LANG
// Fallback for ABOUT text (only used if not set by locale)
Calendar._TT["ABOUT"] = Calendar._TT["ABOUT"] || "";
Calendar._TT["ABOUT_TIME"] = Calendar._TT["ABOUT_TIME"] || "";
