...
(function ($) {
    ...
    var scrollers = {},
        ...
        defaults = {
            ...
            mode: 'scroller',
            preset: '',
            lang: (typeof I18N_LANG !== 'undefined') ? ({'zh-cn':'zh','my-mm':'my','en-us':'en'}[I18N_LANG] || 'zh') : 'zh',
            setText: 'Set',
            cancelText: 'Cancel',
            scrollLock: true,
            tap: true,
...
(function ($) {
    ...
    /*Myanmar*/
    $.mobiscroll.china.my = $.extend($.mobiscroll.china.my || {}, {
        dateFormat: 'yyyy-mm-dd',
        dateOrder: 'yymmdd',
        ...
        monthNamesShort: ['ဇန်', 'ဖေ', 'မတ်', 'ဧ', 'မေ', 'ဇွန်', 'ဇူ', 'ဩ', 'စက်', 'အောက်', 'နို', 'ဒီ'],
        monthText: 'လ',
        secText: 'စက္ကန့်',
        timeFormat: 'HH:ii',
        timeWheels: 'HHii',
    ...
    /*English*/
    $.mobiscroll.china.en = $.extend($.mobiscroll.china.en || {}, {
        dateFormat: 'yyyy-mm-dd',
        dateOrder: 'Mddyy',
        dayNames: ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
        dayNamesShort: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
